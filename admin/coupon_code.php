...
<div class="card">
            <div class="card-body">
              <h4 class="card-title_new">Coupon Code Master</h4>
              <a type="submit" name="submit"href="manage_coupon_code.php" class="btn btn-success btn-sm margin1">Add Coupon Code</a>
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      <thead>
                        <tr>
                            ...
                            <th with="10%">Type</th>                           
                             <th with="35%">Value</th>
                            <th with="10%">Min value</th>                            
                            <th with="35%">Expired</th>
                      ...
                      ?>
                        <tr>
                            ...
                            <td>
                             ...
                             <a href="manage_coupon_code.php?id=<?=$row['id'];?>&type=edit"><label class="badge badge-info">Edit</label></a>
