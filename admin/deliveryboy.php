...
<div class="card">
            <div class="card-body">
              <h4 class="card-title_new">Delivery Boy Master</h4>
              <a type="submit" name="submit"href="manage_deliverboy.php" class="btn btn-success btn-sm margin1">Add Delivery Boy</a>
              <div class="row">
                <div class="col-12">
                      ...
                      ?>
                        <tr>
                            ...
                            <td>
                             ...
                             <a href="manage_deliverboy.php?id=<?=$row['id'];?>&type=edit"><label class="badge badge-info">Edit</label></a>
